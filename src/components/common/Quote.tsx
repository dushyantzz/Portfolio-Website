  ...
  return (
    <Container className="py-16">
      <div className="dark:border-dark-white-50 relative rounded-xl border px-4 py-10">
        ...
        <p className="text-foreground/90 relative z-10 text-pretty text-lg leading-relaxed font-medium italic sm:text-xl md:text-2xl">
          “{quote}”
        </p>
        <p className="text-muted-foreground mt-5 text-right text-base leading-snug font-medium italic sm:text-lg md:text-xl">
          — {author}
        </p>
      </div>
    </Container>
